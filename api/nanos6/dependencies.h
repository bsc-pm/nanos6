...
void nanos_register_read_depinfo(void *handler, void *start, size_t length, int symbol_index);
...
//! \param[in] start first address accessed
//! \param[in] length number of bytes until and including the last byte accessed
void nanos_register_write_depinfo(void *handler, void *start, size_t length, int symbol_index);
...
//! \param[in] start first address accessed
//! \param[in] length number of bytes until and including the last byte accessed
void nanos_register_readwrite_depinfo(void *handler, void *start, size_t length, int symbol_index);
...
//! \param[in] start first address accessed
//! \param[in] length number of bytes until and including the last byte accessed
void nanos_register_commutative_depinfo(void *handler, void *start, size_t length, int symbol_index);
...
//! \param[in] start first address accessed
//! \param[in] length number of bytes until and including the last byte accessed
void nanos_register_concurrent_depinfo(void *handler, void *start, size_t length, int symbol_index);
...
//! \param[in] start first address accessed
//! \param[in] length number of bytes until and including the last byte accessed
void nanos_register_weak_read_depinfo(void *handler, void *start, size_t length, int symbol_index);
...
//! \param[in] start first address accessed
//! \param[in] length number of bytes until and including the last byte accessed
void nanos_register_weak_write_depinfo(void *handler, void *start, size_t length, int symbol_index);
...
//! \param[in] start first address accessed
//! \param[in] length number of bytes until and including the last byte accessed
void nanos_register_weak_readwrite_depinfo(void *handler, void *start, size_t length, int symbol_index);
