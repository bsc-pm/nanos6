...
static void nanos6_register_task_info_unused(__attribute__((unused)) nanos6_task_info *task_info)
{
}
...
{
	typedef void nanos6_register_task_info_t(nanos6_task_info *task_info);
