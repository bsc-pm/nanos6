...
namespace Instrument {
	...
	//! \brief Called in discrete dependencies when two automatas exchange a message
	//!
	//! \param dataAccessIdFrom is the the instrumentation id of the access who created the message
	//! \param dataAccessIdTo is the the instrumentation id of the access who receives the message
	//! \param flags is the content of the message
	//! \param oldFlags is the state of the "to" access before the message was delivered
