...
namespace Instrument {
	task_id_t enterCreateTask(nanos6_task_info_t *taskInfo, nanos6_task_invocation_info_t *taskInvokationInfo, size_t flags, InstrumentationContext const &context);
	...
	void exitSubmitTask(task_id_t taskId, InstrumentationContext const &context);
