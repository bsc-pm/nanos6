...
namespace Instrument {
	...
	void upgradedDataAccessInSequence(data_access_sequence_id_t dataAccessSequenceId, data_access_id_t dataAccessId, DataAccess::type_t previousAccessType, DataAccess::type_t newAccessType, bool becomesUnsatisfied, task_id_t originatorTaskId);
