...
//! \brief check if the runtime supports CPU activation and deactivation
//! \returns 1 if the runtime supports sactivating and deactivating CPUs, or 0 otherwise
//! \sa nanos_get_current_system_cpu, nanos_enable_cpu, nanos_disable_cpu, nanos_get_cpu_status
//! \sa nanos_cpus_begin, nanos_cpus_end, nanos_cpus_advance, nanos_cpus_get
