...
public:
	...
	{
		FatalErrorHandler::failIf(true, "getComputePlaceCount method cannot be called for this DeviceFunction");
		return 0;
	}

	virtual ComputePlace *getComputePlace(int)
	{
		FatalErrorHandler::failIf(true, "getComputePlace method cannot be called for this DeviceFunction");
		return 0;
	}
