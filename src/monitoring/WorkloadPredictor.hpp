...
private:
	...
	inline workload_t getLoadId(monitoring_task_status_t taskStatus)
	{
		switch (taskStatus) {
			case ready_status:
				return ready_load;
...
public:
	...
	void taskCreated(TaskStatistics *taskStatistics);
	...
	//!
	//! \param[in,out] taskStatistics The task's statistics
	void taskCompletedUserCode(TaskStatistics *taskStatistics);
	...
	inline size_t getNumInstances(workload_t loadId)
	{
