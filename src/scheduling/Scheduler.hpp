...
public:
	...
	static inline bool requestPolling(HardwarePlace *hardwarePlace, polling_slot_t *pollingSlot)
	{
	...
	static bool releasePolling(HardwarePlace *hardwarePlace, polling_slot_t *pollingSlot)
	{
