...
#include "FIFOImmediateSuccessorWithMultiPollingScheduler.hpp"
...
FIFOImmediateSuccessorWithMultiPollingScheduler::FIFOImmediateSuccessorWithMultiPollingScheduler(__attribute__((unused)) int numaNodeIndex)
	: _pollingSlot(nullptr)
{
}

FIFOImmediateSuccessorWithMultiPollingScheduler::~FIFOImmediateSuccessorWithMultiPollingScheduler()
{
}


Task *FIFOImmediateSuccessorWithMultiPollingScheduler::getReplacementTask(__attribute__((unused)) CPU *computePlace)
{
...
void FIFOImmediateSuccessorWithMultiPollingScheduler::taskGetsUnblocked(Task *unblockedTask, __attribute__((unused)) ComputePlace *computePlace)
{
...
Task *FIFOImmediateSuccessorWithMultiPollingScheduler::getReadyTask(ComputePlace *computePlace, __attribute__((unused)) Task *currentTask, bool canMarkAsIdle)
{
	Task *task = nullptr;
...
ComputePlace *FIFOImmediateSuccessorWithMultiPollingScheduler::getIdleComputePlace(bool force)
{
	std::lock_guard<spinlock_t> guard(_globalLock);
...
void FIFOImmediateSuccessorWithMultiPollingScheduler::disableComputePlace(ComputePlace *computePlace)
{
	if (computePlace->_schedulerData != nullptr) {
...
bool FIFOImmediateSuccessorWithMultiPollingScheduler::requestPolling(ComputePlace *computePlace, polling_slot_t *pollingSlot)
{
	Task *task = nullptr;
...
bool FIFOImmediateSuccessorWithMultiPollingScheduler::releasePolling(ComputePlace *computePlace, polling_slot_t *pollingSlot)
{
...
std::string FIFOImmediateSuccessorWithMultiPollingScheduler::getName() const
{
	return "fifo-immediate-successor-with-multi-polling";
}
