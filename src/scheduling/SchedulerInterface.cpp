...
ConfigVariable<bool> SchedulerInterface::_enableImmediateSuccessor("scheduler.enable_immediate_successor", true);
ConfigVariable<bool> SchedulerInterface::_enablePriority("scheduler.enable_priority", true);
