...
usage() {
	...
	echo ""
	echo "  Description:"
	echo "    The script extracts and embeds the external dependencies in the '${deps_base_directory}' directory, prepares"
	...
	echo ""
	echo "  Options:"
	echo "    --embed-hwloc VERSION     Embed the hwloc sources in '${hwloc_directory}' with the '${hwloc_directory}-VERSION.tar.gz'"
	echo "                              tarball. The VERSION value can be 'default' to use the default hwloc version"
	echo "    --embed-jemalloc VERSION  Embed the jemalloc sources in '${jemalloc_directory}' with the '${jemalloc_directory}-VERSION.tar.gz'"
	echo "                              tarball. The VERSION value can be 'default' to use the default jemalloc version"
